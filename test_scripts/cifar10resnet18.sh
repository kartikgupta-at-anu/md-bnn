...
pr='SOFTMAX'
mt='MDA_SOFTMAX'
evalfile='saved_models/CIFAR10/RESNET18/MDA_SOFTMAX/best_model.pth.tar'
...
evalfile='saved_models/CIFAR10/RESNET18/SOFTMAX_PROJECTION/best_model.pth.tar'
...
pr='TANH'
mt='MDA_TANH'
evalfile='saved_models/CIFAR10/RESNET18/MDA_TANH/best_model.pth.tar'
...
pr='TANH'
mt='TANH_PROJECTION'
evalfile='saved_models/CIFAR10/RESNET18/TANH_PROJECTION/best_model.pth.tar'
