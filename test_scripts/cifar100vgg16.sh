...
pr='SOFTMAX'
mt='MDA_SOFTMAX'
evalfile='saved_models/CIFAR100/VGG16/MDA_SOFTMAX/best_model.pth.tar'
...
evalfile='saved_models/CIFAR100/VGG16/SOFTMAX_PROJECTION/best_model.pth.tar'
...
pr='TANH'
mt='MDA_TANH'
evalfile='saved_models/CIFAR100/VGG16/MDA_TANH/best_model.pth.tar'
...
pr='TANH'
mt='TANH_PROJECTION'
evalfile='saved_models/CIFAR100/VGG16/TANH_PROJECTION/best_model.pth.tar'
